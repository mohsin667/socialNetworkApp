    ...
    <Page title="Edit Post">
      <form onSubmit={submitHandler}>
        <div className="form-group">
          ...
          <input onChange={(e)=>{dispatch({type: "titleChange", value: e.targe.value})}} value={state.title.value} autoFocus name="title" id="post-title" className="form-control form-control-lg form-control-title" type="text" placeholder="" autoComplete="off" />
        </div>
