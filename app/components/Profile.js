...
function Profile() {
  ...
  return (
    <Page title="Profile Screen">
      <h2>
        <img className="avatar-small" src={state.profileData.profileAvatar} /> {state.profileData.profileUsername[0].toUpperCase()+state.profileData.profileUsername.slice(1,state.profileData.profileUsername.length) }
